    ...
    return (
        <main className='py-10'>
            <header>
                ...
                <SectionHeader title='The Scholarship Community' description='Despite public primary schools being free of cost in Bangladesh,
...
Your scholarship helps a child attend school and support their families at the same time.'></SectionHeader>
            ...
            <div className='container mx-auto grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5'>
